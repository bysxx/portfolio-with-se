...
const skills: ISkill[] = [
...

  {
    ...
    description: [
      '<b>JavaScript의 핵심 원리</b>를 이해하고 있습니다.',
...
export default function SkillSection() {
  return (
    <section className="flex min-h-screen-nav w-full snap-center flex-col items-start">
      <div className="font-skill-title w-full bg-black px-[178px]">Skills</div>
      <ul className="flex w-full flex-col">
        {skills.map((skill) => (
          <li
            key={skill.title}
            className="grid grid-cols-[1fr_600px] justify-between gap-10 border-b border-black px-[178px] py-8"
          >
